    ...
    <nav class="nav-breadcrumb">
        <div class="nav-wrapper">
            <div class="col s12">
                ...
                <a href="<?php echo $_SESSION['baseurl']; ?>common/company-website.php" class="breadcrumb">Company Website</a>
            </div>
        </div>
    </nav>
    <form class="col s12 card-panel" action="validate.php" method="post" autocomplete="off">
        <div class="row">
            <div class="input-field col s12">
                ...
                <label for="username">Enter Company Website (eg: www.example.com)</label>
            </div>
        </div>
        <div class="row">
            <div class="input-field col s12">
